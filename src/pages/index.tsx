...
const Home = () => {
  return <div className={"relative pb-10"}>
    ...
    <div
      className="relative pt-2 lg:pt-3 flex items-center justify-between text-gray-700 font-semibold text-sm leading-6 dark:text-gray-200">
      <Navigation/>
    </div>
    ...
    <div className="relative max-w-5xl mx-auto pt-20 text-center sm:pt-24 lg:pt-32">
      <h1
        ...
        Relation Transcript and genome.
      </h1>
